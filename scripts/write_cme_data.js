...
const script = `import { AcademicTerm, AggregatedStats, LocalAuthority, ReasonBreakdown, Region, TermDataPoint } from '../types';
...
fs.writeFileSync("src/data/cmeData.ts", script);
console.log("Wrote src/data/cmeData.ts cleanly!");
